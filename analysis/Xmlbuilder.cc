 ...
 */
BoxDim::BoxDim(double Len)
    {
    // sanity check
    assert(Len > 0);
    
    // assign values
    xlo = ylo = zlo = -Len/double(2.0);
    xhi = zhi = yhi = Len/double(2.0);
    }
 ...
 */
BoxDim::BoxDim(double Len_x, double Len_y, double Len_z)
    {
    // sanity check
    assert(Len_x > 0 && Len_y > 0 && Len_z > 0);
    
    // assign values
    xlo = -Len_x/double(2.0);
    xhi = Len_x/double(2.0);
    
    ylo = -Len_y/double(2.0);
    yhi = Len_y/double(2.0);
    
    zlo = -Len_z/double(2.0);
    zhi = Len_z/double(2.0);
    }
